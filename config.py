...
root = '/data/DataSets/datasets/'
# root = '/data/DataSets/'

#Attribute Dictionary for Dataset
__C.DATASET = AttrDict()
#Cityscapes Dir Location
__C.DATASET.CITYSCAPES_DIR = root+'Cityscapes'
#SDC Augmented Cityscapes Dir Location
__C.DATASET.CITYSCAPES_AUG_DIR = ''
#Mapillary Dataset Dir Location
__C.DATASET.MAPILLARY_DIR = root+'Mapillary'
#GTAV, BDD100K Dataset Dir Location
__C.DATASET.GTAV_DIR = root+'GTAV'
__C.DATASET.BDD_DIR = root+'BDD100K'
#Synthia Dataset Dir Location
__C.DATASET.SYNTHIA_DIR = root+'Synthia'
