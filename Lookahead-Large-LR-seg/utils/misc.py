...
def evaluate_eval_for_inference(hist, dataset=None):
    ...
    logging.warning('mean {}'.format(mean_iu))
...
def print_evaluate_results(hist, iu, dataset_name=None, dataset=None):
    ...
    logging.warning('Dataset name: {}'.format(dataset_name))
    logging.warning('IoU:')
    logging.warning('label_id      label    iU    Precision Recall TP     FP    FN')
...
def get_data(data):
    ...
    return aux_gts, gts, inputs, batch_pixel_size
